...
![Выбираем какие тесты хотим запустить и запускаем кнопкой Run workflow](![image](https://github.com/Sergey-Bl/exam_tests_project/assets/20835954/21ff93de-f971-4c5d-9945-a266a02672c2)
)
