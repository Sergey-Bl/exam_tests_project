...
Выбираем тесты и Run Wokflow 
![photo_2024-03-31_13-49-23](https://github.com/Sergey-Bl/exam_tests_project/assets/20835954/f130af51-2ed0-466a-a2fd-6ed5cb7f5dc9)


Выбираем какие тесты хотим запустить и запускаем кнопкой Run workflow ![photo_2024-03-31_13-54-00](https://github.com/Sergey-Bl/exam_tests_project/assets/20835954/6c2f8eb5-5add-4988-9381-7ddfa92f28e6)
...
- Есть автоматическое разворачивание тестов на гите / автоматическое разворачивание репорта в git pages

------
Сгенерированный репорт последнего запуска тут:
https://sergey-bl.github.io/exam_tests_project/#
